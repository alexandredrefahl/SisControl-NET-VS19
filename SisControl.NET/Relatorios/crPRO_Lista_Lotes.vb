...
Public Class crPRO_Lista_Lotes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SisControl.NET.crPRO_Lista_Lotes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrPRO_Lista_Lotes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crPRO_Lista_Lotes = New crPRO_Lista_Lotes()
        rpt.Site = Me.Site
        Return rpt
    End Function
