...
Public Class rptProd_por_Periodo
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptProd_por_Periodo.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SisControl.NET.rptProd_por_Periodo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptProd_por_Periodo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptProd_por_Periodo = New rptProd_por_Periodo()
        rpt.Site = Me.Site
        Return rpt
    End Function
