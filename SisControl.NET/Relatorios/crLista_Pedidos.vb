...
Public Class crLista_Pedidos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SisControl.NET.crLista_Pedidos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrLista_Pedidos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crLista_Pedidos = New crLista_Pedidos()
        rpt.Site = Me.Site
        Return rpt
    End Function
