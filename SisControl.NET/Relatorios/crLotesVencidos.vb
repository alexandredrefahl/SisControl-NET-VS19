...
Public Class crLotesVencidos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SisControl.NET.crLotesVencidos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrLotesVencidos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crLotesVencidos = New crLotesVencidos()
        rpt.Site = Me.Site
        Return rpt
    End Function
