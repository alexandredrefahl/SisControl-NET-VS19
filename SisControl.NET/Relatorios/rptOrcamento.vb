...
Public Class rptOrcamento
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SisControl.NET.rptOrcamento.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_IDOrcamento() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptOrcamento
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptOrcamento = New rptOrcamento()
        rpt.Site = Me.Site
        Return rpt
    End Function
