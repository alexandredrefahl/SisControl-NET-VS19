...
Public Class rptEtiquetas_Clientes
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptEtiquetas_Clientes.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SisControl.NET.rptEtiquetas_Clientes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEtiquetas_Clientes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEtiquetas_Clientes = New rptEtiquetas_Clientes()
        rpt.Site = Me.Site
        Return rpt
    End Function
