...
Public Class PRO_Prod_Periodo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SisControl.NET.PRO_Prod_Periodo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPRO_Prod_Periodo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PRO_Prod_Periodo = New PRO_Prod_Periodo()
        rpt.Site = Me.Site
        Return rpt
    End Function
