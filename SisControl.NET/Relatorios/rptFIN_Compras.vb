...
Public Class rptFIN_Compras
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SisControl.NET.rptFIN_Compras.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFIN_Compras
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFIN_Compras = New rptFIN_Compras()
        rpt.Site = Me.Site
        Return rpt
    End Function
