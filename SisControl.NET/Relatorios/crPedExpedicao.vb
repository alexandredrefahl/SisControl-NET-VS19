...
Public Class crPedExpedicao
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SisControl.NET.crPedExpedicao.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrPedExpedicao
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crPedExpedicao = New crPedExpedicao()
        rpt.Site = Me.Site
        Return rpt
    End Function
